...
class POLIIGON_OT_model(Operator):
    ...
    do_use_collection: BoolProperty(
        name=_t("Import as collection"),  # noqa: F722  # type: ignore
    ...
    size: EnumProperty(
        ...
        description=_t("Change size of assigned textures."))  # noqa: F722  # type: ignore
    lod: EnumProperty(
        name=_t("LOD"),  # noqa: F821
        items=_fill_lod_drop_down,
        description=_t("Change LOD of the Model."))  # noqa: F722  # type: ignore
