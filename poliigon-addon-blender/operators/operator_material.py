...
class POLIIGON_OT_material(Operator):
    ...
    if bpy.app.version >= (3, 0):
        mode_disp: EnumProperty(name="Displacement",  # noqa: F821
                                items=_get_dispopts,
                                default=0,  # noqa: F821
                                update=_update_displacement_options)  # type: ignore
    else:
        mode_disp: EnumProperty(name="Displacement",  # noqa: F821
                                items=_get_dispopts,
                                update=_update_displacement_options)  # type: ignore
    ...
    do_rename: BoolProperty(options={"HIDDEN"})  # noqa: F821  # type: ignore
    do_apply: BoolProperty(options={"HIDDEN"}, default=True)  # noqa: F821  # type: ignore
    ignore_map_prefs: BoolProperty(options={"HIDDEN"}, default=False)  # noqa: F821  # type: ignore
    ...
    def execute(self, context):
        ...
        # Getting the image as 1K or 2K or etc
