...
def build_ui(ui, context):
    ...
    # Reset Filter to Online if any search term is added (only if not persist_filters)
    if not props_wm.persist_filters:
    ...
    cTB.vSearch[KEY_TAB_RECENTLY_VIEWED] = props_wm.search
