...
def is_eevee_next() -> bool:
    ...
    # Renamed back to BLENDER_EEVEE in 5.0
    is_next_5x = bpy.app.version >= (5, 0) and engine == "BLENDER_EEVEE"
    # Blender 4.2's Eevee Next supports for example displacement
    # (but not adaptive)
    is_next_4x = bpy.app.version < (5, 0) and engine == "BLENDER_EEVEE_NEXT"
    return is_next_4x or is_next_5x
